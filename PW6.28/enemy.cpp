...
flower_yousei::flower_yousei(int x_,int y_){
...
light_butterfly::light_butterfly(int x_, int y_){
...
dark_butterfly::dark_butterfly(int x_, int y_){
...
mid_butterfly::mid_butterfly(int x_, int y_){
